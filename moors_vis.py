...
from matplotlib.colors import rgb_to_hsv, hsv_to_rgb,ListedColormap, LinearSegmentedColormap
import pytz
...
windspeed_cmap = cm.get_cmap('hsv')# wind_cmap
...
def get_image(data):
    ...
    if season == "spring":
        ...
        season_col = [242.0*cc,248.0*cc,255.0*cc] #white
    ...
    colour_im_array = np.zeros([256,384,3])
    colour_im_array[0:128,0:256] = wind_col
    colour_im_array[0:128,128:256] = sol_el_col[0:3]
    colour_im_array[0:128,256:384] = cloud_col[0:3]
    colour_im_array[128:256,0:128] = temp_col[0:3]
    colour_im_array[128:256,128:256] = rain_col[0:3]
    colour_im_array[128:256,256:384] = season_col
